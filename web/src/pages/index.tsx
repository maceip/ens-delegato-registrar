...
export default function App() {
  ...
  const requestBody: WorkerRequest = {
    name: `${debouncedName}.delegato.eth`,
    owner: address!,
  ...
  } = useFetch(data && 'https://gw.delegato.workers.dev/set', {
    method: 'POST',
    headers: {
     ...
     <img width={90} src ="/delegato.jpg"/>
        ...
        <Form
          onSubmit={(e) => {
            e.preventDefault()
            signMessage({
              message: `Register ${debouncedName}.delegato.eth`,
            })
          }}
        >
          <Input
        ...
        {gatewayError ? (
          ...
          <Helper>
            <p>
              Visit the{' '}
              <Link href={`https://ens.app/${debouncedName}.maceip.eth`}>
                ENS Manager
              </Link>{' '}
              to see your name
            </p>
